...
<body>
	<div id="wrapper">
        ...
        <div id="containerHolder">
			...
			<div id="sidebar">
                ...
                <h3 align="center">Teacher Section : Manage Teachers</h3>
				...
				<th align="center">Teacher Password</th>
		      ...
		      <?php
				...
				$query = mysqli_query($con,"Select * from teacher_info"); // SQL Query
				while($row = mysqli_fetch_array($query))
				{
					...
					Print "<tr>";
						...
						Print '<td align="center">'. $row['teacher_pass'] . "</td>";
	...
	<script>
			...
			{
			window.location.assign("delete_teacher.php?id=" + id);
			  }
		</script>
</body>
</html>
