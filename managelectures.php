...
<body>
	<div id="wrapper">
        ...
        <div id="containerHolder">
			...
			<div id="sidebar">
                ...
                <h3 align="center">Teacher Section : Manage Lectures</h3>
				...
				<th align="center">Teacher Subject</th>
		      ...
		      <?php
				...
				$query = mysqli_query($con,"Select * from lectures_info"); // SQL Query
				while($row = mysqli_fetch_array($query))
				{
					
					Print "<tr>";
					    Print '<td align="center">'. $row['id'] . "</td>";
						Print '<td align="center">'. $row['teacher_id'] . "</td>";
						Print '<td align="center">'. $row['teacher_name'] . "</td>";
						Print '<td align="center">'. $row['teacher_subject'] . "</td>";
						Print '<td align="center">'. $row['day_of_lecture'] . "</td>";
						Print '<td align="center">'. $row['time_of_lecture'] . "</td>";
						Print '<td align="center">'. $row['class_name'] . "</td>";
						Print '<td align="center">'. $row['no_of_students'] . "</td>";
	...
	<script>
			...
			{
			window.location.assign("delete_lecture.php?id=" + id);
			  }
		</script>
</body>
</html>
